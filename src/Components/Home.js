        ...
        <Row>
          <Col xs={12} md={4}>
            <div className="category">
              <img src="https://prasadyash2411.github.io/ecom-website/img/Album%204.png" alt="category" />
              <h3>Category 1</h3>
              <p>Shop Now</p>
            </div>
          </Col>
          <Col xs={12} md={4}>
            <div className="category">
              <img src="https://prasadyash2411.github.io/ecom-website/img/Album%203.png" alt="category" />
              <h3>Category 2</h3>
              <p>Shop Now</p>
            </div>
          </Col>
          <Col xs={12} md={4}>
            <div className="category">
              <img src="https://prasadyash2411.github.io/ecom-website/img/Album%202.png" alt="category" />
              <h3>Category 3</h3>
              <p>Shop Now</p>
            </div>
          </Col>
        ...
        <Row>
          <Col xs={12} md={4}>
            <div className="product">
              <img src="https://prasadyash2411.github.io/ecom-website/img/Album%201.png" alt="product" />
              <h3>Product 1</h3>
              <p>$19.99</p>
            </div>
          </Col>
          <Col xs={12} md={4}>
            <div className="product">
              <img src="https://prasadyash2411.github.io/ecom-website/img/Album%203.png" alt="product" />
              <h3>Product 2</h3>
              <p>$24.99</p>
            </div>
          </Col>
